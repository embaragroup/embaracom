    ...
    <div class="services">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading">
                        <p class="title">Kategori <em>Trip</em></p>
                ...
                <div class="col-md-4">
                    <div class="service-item">
                        ...
                        <div class="down-content">
                            ...
                            <div class="mb">
                                <span> <sup>Rp</sup>{{ number_format(80000) }} - <sup>Rp</sup>{{ number_format(1000000) }}
                                </span>
                            </div>

                            <p class="title-in">Liburan bersama keluarga jadi makin seru, Ciptakan momen istimewa bersama Keluarga anda,
                                bersama kami</p>
                ...
                <div class="col-md-4">
                    <div class="service-item">
                        ...
                        <div class="down-content">
                            <p class="title">MUSIM</p>
                            <div class="mb">
                                <span> <sup>Rp</sup>{{ number_format(500000) }} - <sup>Rp</sup>{{ number_format(1500000) }}
                                </span>
                            </div>

                            <p class="title-in">Nikmati liburan bersama bersama Kami, Pergi ketempat yang belum pernah anda kunjingi dan
                                ciptakan momen spesial.</p>
                ...
                <div class="col-md-4">
                    <div class="service-item">
                        ...
                        <div class="down-content">
                            <p class="title">PELAJAR</p>
                            <div class="mb">
                                <span> <sup>Rp</sup>{{ number_format(150000) }} - <sup>Rp</sup>{{ number_format(500000) }}
                                </span>
                            </div>

                            <p class="title-in">Traveling itu seperti universitas tanpa akhir. Dan Tidak semua ruang kelas memiliki empat
                                dinding. Hidup adalah petualangan yang berani atau tidak sama sekali</p>
